...
EMAIL_HOST_USER = 'linglan520@gmail.com'
EMAIL_HOST_PASSWORD = '831221'
EMAIL_PORT = 587

#-------------------ckeditor-----------------------
#Prefix js,css file of CKEditor
CKEDITOR_MEDIA_PREFIX = "/static/js/ckeditor/"

#Path to upload
CKEDITOR_UPLOAD_PATH = "%(HERE)s/static/upload" % locals()

#File path of upload
CKEDITOR_UPLOAD_PREFIX = "/static/upload/"
